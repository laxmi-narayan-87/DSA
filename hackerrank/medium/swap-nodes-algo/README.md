...
Each of the next `n` lines contains two integers, `a b`, where `a` is the index of left child, and `b` is the index of right child of _i<sup>th</sup>_ node.   
...
**Explanation 2**  
 ...
 Here we perform swap operations at the nodes whose depth is either _2_ or _4_ for $K = 2$ and then at nodes whose depth is _4_ for $K = 4$.
...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-07-23T04:37:46.946Z  
...
[View on HackerRank](https://www.hackerrank.com/challenges/swap-nodes-algo/problem)